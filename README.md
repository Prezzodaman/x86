...
I've also made a start on a Sound Blaster library. This is a huge deal, because it finally allows me to play samples alongside the main loop, in high quality! Even better, it can be used alongside Beeplib to combine beeps and digital samples. It's still a huge work-in-progress, but it's functional enough that it can be used for basic sound effects!
...
Since I've started figuring out the Sound Blaster and how it works, I hope to one day make a sample mixing routine that allows multiple sounds to play at once.
